          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="p-8">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center"><ArrowRight className="w-4 h-4 mr-2" /> Basic Reporting</li>
                <li className="flex items-center"><ArrowRight className="w-4 h-4 mr-2" /> 2 Team Members</li>
              </ul>
            ...
            <Card className="p-8 border-primary">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center"><ArrowRight className="w-4 h-4 mr-2" /> Custom Reports</li>
                <li className="flex items-center"><ArrowRight className="w-4 h-4 mr-2" /> 10 Team Members</li>
              </ul>
              <Button className="w-full">Start Free Trial</Button>
            </Card>
            <Card className="p-8">
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center"><ArrowRight className="w-4 h-4 mr-2" /> Dedicated Support</li>
                <li className="flex items-center"><ArrowRight className="w-4 h-4 mr-2" /> Unlimited Team Members</li>
              </ul>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">contact@moyotools.com</p>
            </div>
            <div className="text-center">
